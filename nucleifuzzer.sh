...
/_/ |_/\__,_/\___/_/\___/_/_/    \__,_/ /___/___/\___/_/
               ...
               customized for own research( Mir Resanul Karim)
...
python3 /home/ubuntu/ParamSpider/paramspider.py -d "$domain" --exclude png,jpg,gif,jpeg,swf,woff,gif,svg --level high --quiet -o /home/ubuntu/paramspider_output.txt

# Step 4: Run the nuclei fuzzer tool on the above text file
echo "Running nuclei fuzzer on paramspider_output.txt"
nuclei -l /home/ubuntu/paramspider_output.txt -t fuzzing-templates -rl 05
